# Verification Checklist - typescript-architectural-fixer
...
# For Python:
pip list | grep -i typescript-architectural-fixer
```
...
cat ~/.claude/.env | grep -i typescript-architectural-fixer
```
