# Installation - typescript-architectural-fixer
...
```bash
cd ~/.claude/skills/typescript-architectural-fixer
ls -la
```
...
```bash
cd ~/.claude/skills/typescript-architectural-fixer/src
npm install
# or
bun install
```
...
1. Copy the example configuration:
   ```bash
   cp ~/.claude/skills/typescript-architectural-fixer/src/config/example.env ~/.claude/.env
   ```
...
claude --help | grep typescript-architectural-fixer
...
**Skill**: typescript-architectural-fixer
**Format**: Pack v2.0
