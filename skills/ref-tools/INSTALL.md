...
```bash
cd ~/.claude/skills/ref-tools/src
npm install
# or
bun install
```
...
1. Copy the example configuration:
   ```bash
   cp ~/.claude/skills/ref-tools/src/config/example.env ~/.claude/.env
   ```
