<template>
  <div class="compact-mode h-screen flex flex-col bg-[var(--theme-bg-secondary)] theme-tokyo-night">
    <!-- Tab Navigation -->
    <div class="tab-navigation bg-[var(--theme-bg-primary)] border-b border-[var(--theme-border)] px-4 py-2 flex items-center gap-2">
      <button
...
const activeTab = ref<'events' | 'routing'>('events');
