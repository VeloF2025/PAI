...
```bash
cd ~/.claude/skills/mt5-trading/src
npm install
# or
bun install
```
...
1. Copy the example configuration:
   ```bash
   cp ~/.claude/skills/mt5-trading/src/config/example.env ~/.claude/.env
   ```
