...
```bash
cd ~/.claude/skills/apex-ui-ux/src
npm install
# or
bun install
```
...
1. Copy the example configuration:
   ```bash
   cp ~/.claude/skills/apex-ui-ux/src/config/example.env ~/.claude/.env
   ```
